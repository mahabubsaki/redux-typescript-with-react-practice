...
const NavBackdrop = () => {
    ...
    return (
        <div className={`fixed inset-0 bg-black bg-opacity-10 backdrop-blur-[1.5px] flex my-xl:hidden duration-500 justify-start z-20`}>
            <div className={`h-[100%] duration-500 ${isSmallOpen ? 'w-[50%]' : 'w-[0%]'} px-[10px] pt-[35px] bg-[#F7F5F2] relative`}>
